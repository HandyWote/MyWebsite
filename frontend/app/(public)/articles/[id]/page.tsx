...
import { articleJsonLd, articleMetadata, getArticlePdfUrl, serializeJsonLd } from '@/seo/site';
    ...
    <>
      ...
      <PublicShell activePath={`/articles/${id}`}>
        ...
        <Box sx={{ border: 1, borderStyle: 'dashed', borderColor: 'divider', p: { xs: 1.25, sm: 3 } }}>
          <Button component="a" href="/articles" variant="text" startIcon={<ArrowLeft size={16} />}>exit buffer</Button>
          <Card component="article" sx={{ mt: 2, p: { xs: 1.5, sm: 3 } }}>
            ...
            {article.content_type === 'pdf' && article.pdf_filename ? (
              <Box component="section" aria-labelledby="pdf-document-heading">
                <Typography id="pdf-document-heading" component="h2" variant="h5" sx={{ mb: 1 }}>PDF document</Typography>
