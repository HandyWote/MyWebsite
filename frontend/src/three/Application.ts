...
export class Application implements ThreeExperience {
  ...
  private readonly resources = new Resources(sources, createBrowserResourceLoader());
  ...
  constructor(private readonly options: ThreeExperienceOptions) {
    ...
    this.pointerTracker = new MonitorPointerTracker(document, options.screenHost, this.camera, this.mouse);
